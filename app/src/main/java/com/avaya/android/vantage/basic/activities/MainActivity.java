...
import com.avaya.android.vantage.basic.VideoDialogFragment;
...
import com.avaya.android.vantage.basic.views.KeysNonVersionControl;
        ...
        socket.on(Socket.EVENT_CONNECT, args -> {
            ...
            try {
                ...
                MainActivity.this.runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        // 2. Create the player
                        player = ExoPlayerFactory.newSimpleInstance(MainActivity.this.getApplicationContext(), trackSelector);
                        simpleExoPlayerView = new SimpleExoPlayerView(MainActivity.this.getApplicationContext());
                        ...
                        //DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(MainActivity.this.getApplicationContext(), Util.getUserAgent(MainActivity.this.getApplicationContext(), "cala"), bandwidthMeter);
                        //MediaSource videoSource = new HlsMediaSource(Uri.parse(mensaje), dataSourceFactory, 1, null, null);
            ...
            try {
                ...
                runOnUiThread(() -> {
                    ...
                    try {
                        mAdapter.addResult(jsonObject.getJSONObject("data").getJSONArray("translations").getJSONObject(0).getString("translatedText"));
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                ...
                textToSpeech = new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
                    ...
                    public void onInit(int status) {
                        if (status == TextToSpeech.SUCCESS) {
                            ...
                            Toast.makeText(MainActivity.this.getApplicationContext(), "TTS Initialization failed!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
